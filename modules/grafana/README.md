...
A [timoni.sh](http://timoni.sh) module for deploying kubevirt to Kubernetes clusters.
...
```shell
timoni -n default apply kubevirt oci://<container-registry-url>
```
...
```shell
timoni -n default delete kubevirt
```
