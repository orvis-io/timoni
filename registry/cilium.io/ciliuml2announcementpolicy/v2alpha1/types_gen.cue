...
// which is used to defined which nodes should announce what
// services on the L2 network.
...
#CiliumL2AnnouncementPolicySpec: {
	...
	// interface(s) should be used to announce the services over. If
	// nil, all network interfaces are used.
	interfaces?: [...string]
	...
	// IPs for the services selected by the service selector.
	...
	// announced over L2 networks. The loadBalancerClass for a
	// service must be nil or specify a supported class, e.g.
	// "io.cilium/l2-announcer". Refer to the following document for
	// additional details regarding load balancer classes:
