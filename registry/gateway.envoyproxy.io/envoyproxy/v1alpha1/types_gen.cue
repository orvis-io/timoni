...
#EnvoyProxySpec: {
	...
	filterOrder?: [...{
		...
		after?: "envoy.filters.http.cors" | "envoy.filters.http.ext_authz" | "envoy.filters.http.basic_authn" | "envoy.filters.http.oauth2" | "envoy.filters.http.jwt_authn" | "envoy.filters.http.fault" | "envoy.filters.http.local_ratelimit" | "envoy.filters.http.ratelimit" | "envoy.filters.http.wasm" | "envoy.filters.http.ext_proc" | "envoy.filters.http.rbac"

		// Before defines the filter that should come before the filter.
		// Only one of Before or After must be set.
		before?: "envoy.filters.http.cors" | "envoy.filters.http.ext_authz" | "envoy.filters.http.basic_authn" | "envoy.filters.http.oauth2" | "envoy.filters.http.jwt_authn" | "envoy.filters.http.fault" | "envoy.filters.http.local_ratelimit" | "envoy.filters.http.ratelimit" | "envoy.filters.http.wasm" | "envoy.filters.http.ext_proc" | "envoy.filters.http.rbac"

		// Name of the filter.
		name: "envoy.filters.http.cors" | "envoy.filters.http.ext_authz" | "envoy.filters.http.basic_authn" | "envoy.filters.http.oauth2" | "envoy.filters.http.jwt_authn" | "envoy.filters.http.fault" | "envoy.filters.http.local_ratelimit" | "envoy.filters.http.ratelimit" | "envoy.filters.http.wasm" | "envoy.filters.http.ext_proc" | "envoy.filters.http.rbac"
	}]
	...
	telemetry?: {
			...
			settings?: list.MaxItems(50) & [...{
				...
				sinks: list.MaxItems(50) & [...{
					...
					als?: {
						...
						// gRPC service to which
						// the access logs will be sent. Currently only Service is
						// supported.
		...
		tracing?: {
			...
			provider: {
				...
				type: "OpenTelemetry" | "Zipkin" | *"OpenTelemetry"
